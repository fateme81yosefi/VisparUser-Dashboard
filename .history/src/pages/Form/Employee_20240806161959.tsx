...
const Employee: React.FC = () => {
    ...
    const { dataPeriodList, setDataPeriodList } = useStore();
    ...
    const [selectedOptions, setSelectedOptions] = useState<{select1: OptionType | null;}>({
        select1: null,
    });

    const handleChange =
        (selectName: 'select1') => (option: OptionType | null) => {
