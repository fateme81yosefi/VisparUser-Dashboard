...
import AssignmentSupervieorDelete from '../../hooks/AssignmentSupervisorIndicator/AssignmentSupervisorDelete';
...
import AssignmentSupervisorIndicatorStore from '../../hooks/AssignmentSupervisorIndicator/AssignmentSupervisorIndicatorStore';
...
import AssignmentSupervieorShow from '../../hooks/AssignmentSupervisorIndicator/AssignmentSupervisorShow';
...
const AssignmentSupervisorIndicator: React.FC = () => {
  ...
  const handleShowItem = async (id: number, selectedSupervisor: any, selectedPeriod: any) => {

    await getAdminSAShowbasedPeriodSupervisorEmployee(selectedSupervisor.value, selectedPeriod.value, id);
  ...
  return (
    <>
      ...
      {showListModal &&
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none upperLayer">
                                    ...
                                    {selectedSupervisor && <td className="flex flex-row	items-center justify-center px-6 py-4 whitespace-nowrap text-end text-sm font-medium border-zinc-200">
                                      <button
                                        ...
                                        onClick={(event) => {
                                          ...
                                          handleShowItem(item.id, selectedSupervisor, selectedPeriod);
                                        }}
                                      >
                                        <img src={addIcon} />
                                      </button>
