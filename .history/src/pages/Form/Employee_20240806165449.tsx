...
import GetEmployeeList from '../../hooks/Employee/GetEmployeeList/GetEmployeeList.tsx';
...
const Employee: React.FC = () => {
    ...
    const handleShowList = async () => {
        ...
        console.log("dataMe.id",dataMe.id)
        console.log("period",period)

        if (dataMe && period) {
            await getEmployeeListData(dataMe.id, period)

        }
        else{
            console.log("djkfbdfghjwsdfhywd")
        }
