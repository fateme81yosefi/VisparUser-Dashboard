...

              {
                otpMode ?
                  ...
                  <form>
                    ...
                    <div className="mb-6">
                      <a onClick={() => setOtpMode(true)} className='customizeATag'><svg style="width: 18px; height: 18px; fill: var(--color-icon-secondary);"><use xlink:href="#chevronLeft"></use></svg>ورود با رمز عبور</a>
                    </div>
