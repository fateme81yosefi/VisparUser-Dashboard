                ...
                otpMode ?
                  <form>
                    ...
                    <div className="mb-6 flex flex-row">
                      <a onClick={() => setOtpMode(false)} className='customizeATag'>  فراموشی رمز عبور</a><img onClick={() => setOtpMode(false)} src={LeftIcon} />
                    </div>
                  ...
                  <form>
                    ...
                    <div className="mb-6 flex fl">
                      <a onClick={() => setOtpMode(true)} className='customizeATag'>ورود با رمز عبور</a><img onClick={() => setOtpMode(false)} src={LeftIcon} />
                    </div>
